        ...
        <nav className="absolute z-10 text-black-pearl-50 w-full h-24 xl:text-sm 2xl:text-base 3xl:text-xl 3xl:h-32">
            <div className="flex justify-between items-center h-full">
                ...
                <div className="hidden xl:flex gap-8 mr-8">
                    <Link to="/wayared?menu=doc" className="transition-colors duration-300 ease-in-out hover:bg-black-pearl-500 p-4 rounded-sm">Documentation</Link>
                    <Link to="/wayared?menu=model" className="transition-colors duration-300 ease-in-out hover:bg-black-pearl-500 p-4 rounded-sm">Models</Link>
                    <Link to="/wayared?menu=result" className="transition-colors duration-300 ease-in-out hover:bg-black-pearl-500 p-4 rounded-sm">Analytical Results</Link>
                    <Link to="/wayared?menu=contact" className="transition-colors duration-300 ease-in-out hover:bg-black-pearl-500 p-4 rounded-sm">Contact us</Link>
                </div>
